var Select = React.createClass({
    ...
    selectChange:function (index) {
        ...
        //触发之前注册的事件changeSelectedIndex，修改selectCont的selectedIndex
        Action.emit("changeSelectedIndex",index)
...
var SelectCont = React.createClass({
    ...
    componentWillMount:function () {
        ...
        //在action里面注册一个方法，修改自己的selectedIndex
        Action.on("changeSelectedIndex",function (index) {
            this.setState({
                selectedIndex:index
            })
        }.bind(this))
    ...
    render:function () {
     ...
     return (
         <div>
             <Select  selectData={this.state.titleData} str="222" />
             <div className="cont">
